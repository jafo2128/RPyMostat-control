# -*- coding: utf-8 -*-
#
# rpymostat-control documentation build configuration file, created by
...
from rpymostat-control.version import _VERSION
...
if is_rtd:
    ...
    htmlhelp_basename = 'rpymostat-controldoc'
...
latex_documents = [
  (master_doc, 'rpymostat-control.tex', u'rpymostat-control Documentation',
...
man_pages = [
    (master_doc, 'rpymostat-control', u'rpymostat-control Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'rpymostat-control', u'rpymostat-control Documentation',
   author, 'rpymostat-control', 'One line description of project.',
   'Miscellaneous'),
]
